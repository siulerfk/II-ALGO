...
class Lista{
	...
	public:
        Lista();
        Lista(Lista<T> &otraLista);	// Constructor copia
...
Lista<T>::add(Lista<T> &otraLista){		// Solo funcina para listas creadas en el stack sin memoria dinamica
	std::cout << "otraLista \n";	///********************************************************
