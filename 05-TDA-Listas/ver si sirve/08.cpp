...
public:
  ...
  void
  baja(int); // baja de la primera aparicion de un elemento determinado
             // modificarlo para que realice la baja de todas las apariciones
  bool esta(int); // retorna un bool indicando si el entero pasado por argumento
                  // está en la lista
...
void lista::altaprin(int x) { p = new nodo(x, p); }

void lista::baja(
    int x) // Elimina la primera aparicion del dato pasado por argumento
{
  if (p) {
